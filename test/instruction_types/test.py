...
tests = [
    {
        ...
        "cmd": [os.path.join(script_dir, "../../build/riscv-objdump"), "-types", os.path.join(script_dir, "inputs/instruction_types_bin.txt"), "binstr"],
        "should-fail": False
    },
    {
        "description": "ASCII hex file",
        "cmd": [os.path.join(script_dir, "../../build/riscv-objdump"), "-types", os.path.join(script_dir, "inputs/instruction_types_hex.txt"), "hexstr"],
        "should-fail": False
    },
    {
        "description": "Raw binary file",
        "cmd": [os.path.join(script_dir, "../../build/riscv-objdump"), "-types", os.path.join(script_dir, "inputs/instruction_types_little.bin"), "bin", "--endian=little"],
        "should-fail": False
    },
    {
        "description": "Raw binary file with wrong endian",
        "cmd": [os.path.join(script_dir, "../../build/riscv-objdump"), "-types", os.path.join(script_dir, "inputs/instruction_types_little.bin"), "bin", "--endian=big"],
        "should-fail": True
    }
]
